I modified/hacked the code to support direct button presses from momentary contact buttons. This involves disabiling the NES controller and SD card features to free up some GPIO pins. This code it meant to be referenced by my You Tube video where I hack a Space Invaders game to use esp_8_bit.
